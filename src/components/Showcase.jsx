...
const showcaseItems = [
  { id: 'f1', month: 1, nameKo: '수선화', nameEn: 'Daffodil', src: flower01, isolatedSrc: flower01Isolated, alt: '1월 수선화 탄생화 디테일', meaning: '자기사랑, 자존심, 고결', colorFilter: 'hue-rotate(-10deg) saturate(0.8) brightness(1.02)' },
  { id: 'f2', month: 2, nameKo: '제비꽃', nameEn: 'Violet', src: flower02, isolatedSrc: flower02Isolated, alt: '2월 제비꽃 탄생화 디테일', meaning: '겸손, 진실한 사랑', colorFilter: 'hue-rotate(110deg) saturate(0.6) brightness(1.05)' },
  { id: 'f3', month: 3, nameKo: '데이지', nameEn: 'Daisy', src: flower03, isolatedSrc: flower03Isolated, alt: '3월 데이지 탄생화 디테일', meaning: '명랑, 순수한 마음', colorFilter: 'hue-rotate(-20deg) saturate(0.7) brightness(1.03)' },
  { id: 'f4', month: 4, nameKo: '스위트피', nameEn: 'Sweet Pea', src: flower04, isolatedSrc: flower04Isolated, alt: '4월 스위트피 탄생화 디테일', meaning: '우아한 추억, 사랑의 기쁨', colorFilter: 'hue-rotate(160deg) saturate(0.7) brightness(1.02)' },
  { id: 'f5', month: 5, nameKo: '은방울꽃', nameEn: 'Lily of the Valley', src: flower05, isolatedSrc: flower05Isolated, alt: '5월 은방울꽃 탄생화 디테일', meaning: '틀림없이 행복해집니다, 순결', colorFilter: 'hue-rotate(40deg) saturate(0.5) brightness(1.08)' },
  { id: 'f6', month: 6, nameKo: '장미', nameEn: 'Rose', src: flower06, isolatedSrc: flower06Isolated, alt: '6월 장미 탄생화 디테일', meaning: '사랑, 아름다움, 열정', colorFilter: 'hue-rotate(180deg) saturate(1.1) brightness(0.98)' },
  { id: 'f7', month: 7, nameKo: '델피늄', nameEn: 'Delphinium', src: flower07, isolatedSrc: flower07Isolated, alt: '7월 델피늄 탄생화 디테일', meaning: '당신을 행복하게 해줄게요, 청명', colorFilter: 'hue-rotate(85deg) saturate(0.8) brightness(1.02)' },
  { id: 'f8', month: 8, nameKo: '글라디올러스', nameEn: 'Gladiolus', src: flower08, isolatedSrc: flower08Isolated, alt: '8월 글라디올러스 탄생화 디테일', meaning: '견고한 성격, 무장, 사랑의 고백', colorFilter: 'hue-rotate(200deg) saturate(0.9) brightness(1.0)' },
  { id: 'f9', month: 9, nameKo: '아스터', nameEn: 'Aster', src: flower09, isolatedSrc: flower09Isolated, alt: '9월 아스터 탄생화 디테일', meaning: '추억, 믿음, 사랑의 결실', colorFilter: 'hue-rotate(100deg) saturate(0.7) brightness(1.02)' },
  { id: 'f10', month: 10, nameKo: '금잔화', nameEn: 'Marigold', src: flower10, isolatedSrc: flower10Isolated, alt: '10월 금잔화 탄생화 디테일', meaning: '우정, 예언, 이별의 슬픔', colorFilter: 'hue-rotate(-15deg) saturate(1.2) brightness(0.98)' },
  { id: 'f11', month: 11, nameKo: '국화', nameEn: 'Chrysanthemum', src: flower11, isolatedSrc: flower11Isolated, alt: '11월 국화 탄생화 디테일', meaning: '청조, 평화, 지조', colorFilter: 'hue-rotate(-5deg) saturate(0.9) brightness(0.95)' },
  { id: 'f12', month: 12, nameKo: '포인세티아', nameEn: 'Poinsettia', src: flower12, isolatedSrc: flower12Isolated, alt: '12월 포인세티아 탄생화 디테일', meaning: '축복, 뜨거운 마음', colorFilter: 'hue-rotate(190deg) saturate(1.2) brightness(0.95)' },
];
